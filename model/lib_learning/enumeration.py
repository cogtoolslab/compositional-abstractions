...
def multicoreEnumeration(g, tasks, _=None,
                         ...
                         testing=False,
                         filepath='./enumeration/',
                         filename='enumeration_output'):
    ...
    while True:
        ...
        if message.result == "failure":
            ...
            for t, f in newFrontiers.items():
                ...
                pickle.dump(frontiers[t], open((filepath + 'task' + t.name + '_' + filename +'.p'), "wb" ))
        else:
    ...
    all_frontiers = ([frontiers[t] for t in tasks], bestSearchTime)

    pickle.dump(all_frontiers, open((filepath + filename +'.p'), "wb" ))
