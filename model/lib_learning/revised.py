...
<<<<<<< HEAD:syn/fragment_plotting_revised.py
data_path = './results/revised/38/'
=======
data_path = '/Volumes/Passport/Code/caml/syn/results/revised/1/'
>>>>>>> 7358cabe80592eb997ce24980975d3e1f7b4f81a:syn/revised.py
vis_path = './vis2/'
...
print('this is ffrags_low!')
print(ffrags_low)
print('this is ttowers_low!')
print(ttowers_low)
print('this is ppairs_low!')
print(ppairs_low)
# exit()
