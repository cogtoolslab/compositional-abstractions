...
#### 'pilot_class': 
* Dataset obtained from university class
* Only grab full datasets, and ones that started in the first 20 minutes (to prevent people from restarting if they lost connection)