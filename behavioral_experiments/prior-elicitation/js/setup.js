...
function setupGame() {
  socket.on('onConnected', function (d) {
    ...
    var instructionsHTML = {
      ...
      'str2': "<p> When you finish, please click the submit button to finish the task. If a popup appears asking you if you are sure you want to leave the page, \
      you must click YES to confirm that you want to leave the page. This will cause the study to submit. Let's begin!"
    };

    // add consent pages
    consentHTML = {
      'str1': '<p style="text-align:center;"> <b> We are scientists interested in understanding how computers \
      can learn like humans. </b></p> \
      <p style="text-align:center;"> In this study, you will be viewing some of the arrangements of computer \
      generated towers and describing them.</p>',
    ...
    var exitSurveyText = _.extend({}, surveyTextInfo, {
      ...
      questions: [
        ...
        { prompt: "What strategies did you use to describe the towers?", rows: 5, columns: 40 },
